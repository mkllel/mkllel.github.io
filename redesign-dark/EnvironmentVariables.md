...
3. Enable Authentication and add Email/Password for the private administrator account
...
`VITE_FIREBASE_AUTH_DOMAIN` should usually be `your-project-id.firebaseapp.com`. Add only the domains used by the private administrator login to Firebase Authentication > Settings > Authorized domains.

Do not place an administrator email or password in a `VITE_` variable. Vite exposes all `VITE_` values to client-side JavaScript.
